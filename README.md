...
- **Flexible constraint types**: unary, binary (equals, not-equals, offset, comparator, element, predicate, tuples), and n-ary (AllDiff, AtMostOne, AtLeastN, AtMostN, ExactlyOne, Sum, Linear, Count, Tuples, Increasing, Decreasing, predicate)
