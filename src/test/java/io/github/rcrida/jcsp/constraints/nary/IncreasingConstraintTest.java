...
public class IncreasingConstraintTest {
    ...
    void propagate_discrete_narrowingEmptiesGappedMiddleDomain_infeasible() {
        ...
        var v1Domain = NumericDiscreteDomain.of(4);
        var v2Domain = NumericDiscreteDomain.of(0, 10);
        var v3Domain = NumericDiscreteDomain.of(5);
    ...
    void propagate_nonNumericComparableChain_stillPropagates() {
        ...
        Domain<String> d1 = DiscreteDomain.of("a", "b", "m");
        Domain<String> d2 = DiscreteDomain.of("c", "d");
        Domain<String> d3 = DiscreteDomain.of("e", "z");
    ...
    void propagate_nonNumericComparableChain_prunesBothBelowMinAndAboveMax() {
        ...
        var chain = IncreasingConstraint.of(List.of(s1, s2, s3));
        Domain<String> d1 = DiscreteDomain.of("c");
        Domain<String> d2 = DiscreteDomain.of("a", "b", "c", "d", "e", "z");
        Domain<String> d3 = DiscreteDomain.of("d");
        var result = chain.propagate(Map.of(s1, d1, s2, d2, s3, d3)).orElseThrow();
    ...
    void explainInfeasible_citesNonAdjacentSingletonPair() {
        ...
        var result = constraint.explainInfeasible(Map.of(
                v1, NumericDiscreteDomain.of(10), v2, IntRangeDomain.of(0, 20),
                v3, IntRangeDomain.of(0, 20), v4, NumericDiscreteDomain.of(3)));
