 ...
 * {@link BoundSolver#getSolution()} in the satisfaction chain ({@link DomWdegLubySearch}'s
 * Luby-restart search). {@link BoundSolver#getSolutions()} truncates the stream silently instead,
 * and the optimization chain ({@link BranchAndBoundSolver}) returns the best incumbent found so far
