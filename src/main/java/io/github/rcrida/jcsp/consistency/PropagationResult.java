 ...
 * <p>
 * When {@link #isInfeasible()} is true the constraint detected a domain wipeout; {@link #reason}
 ...
 * When feasible, {@link #updatedDomains} is non-null and {@link #reason} is always {@code null}: no
