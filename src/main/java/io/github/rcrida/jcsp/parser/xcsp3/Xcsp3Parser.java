 ...
 * {@code nValues}, {@code cardinality} (fixed-value/fixed-occurrence form only -- see {@link
 ...
 * binPacking}, and single {@code minimize}/{@code maximize} objectives. A {@code group} or {@code
